...
from airflow.providers.google.cloud.operators.dataproc import DataprocCreateBatchOperator # Server less dataproc
...
with DAG(
    ...
    gcs_bucket = Variable.get("gcs_bucket", default_var="airflow-projetcs-gds-dev1")
    bq_project = Variable.get("bq_project", default_var="my-project-demo-477712")
    ...
    # Generate a unique batch ID using UUID for dataproc serverless since dataproc serverless always 
    # need unique value
    ...
    file_sensor = GCSObjectExistenceSensor(
        ...
        poke_interval=30,  # Time between checks in seconds
